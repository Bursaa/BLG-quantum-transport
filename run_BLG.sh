...
JOB_NAME="${SLURM_JOB_NAME:-BLG_data}"
...
# Dla python-mumps/Kwant: inicjalizuj MPI przed importem kwant,
# oraz omiń OFI (na części węzłów powoduje fi_domain Function not implemented).
